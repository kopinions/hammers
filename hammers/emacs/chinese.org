...
*** 安装 librime
    #+BEGIN_SRC shell :exports code :results none :tangle no  :eval (or (and (eq m/os 'linux) "yes") "never") :comments link
...
*** 安装 liberime
    ...
    #+BEGIN_SRC elisp :eval never :exports code :tangle (or (and (eq m/os 'linux) (m/resolve "${m/home.d}/.emacs.d/lisp/init-chinese.el")) "no") :comments link
