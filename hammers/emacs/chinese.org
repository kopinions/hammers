...
*** 修复 liberime-core.so 的链接的问题（@rpath librime not found）
    ...
    #+HEADER: :var erime_path=(m/resolve "${m/xdg.conf.d}/emacs/3rdparty/liberime/src")
    #+HEADER: :var rpath=(m/resolve "${m/xdg.conf.d}/emacs/3rdparty/librime/build/lib/Release") 
