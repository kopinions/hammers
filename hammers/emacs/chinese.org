...
*** 安装 liberime
    ...
    #+BEGIN_SRC elisp :eval never :exports code :tangle (or (and (eq m/os 'macos) "~/.emacs.d/lisp/init-chinese.el") "no") :comments link
    ...
    #+BEGIN_SRC yaml :tangle "~/.emacs.d/rime/default.custom.yaml" :noweb yes :eval never :exports code :comments link
      patch:
	menu/page_size: 100
