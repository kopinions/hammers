...
*** 包加载路径配置
    ...
    #+BEGIN_SRC elisp :eval never :exports code :tangle (m/resolve "${m/xdg.conf.d}/emacs/init.el") :comments link
      ...
      (add-to-list 'load-path (expand-file-name "lsp-ivy/" (expand-file-name "emacs/3rdparty" m/xdg.conf.d)))
      (add-to-list 'load-path (expand-file-name "rg.el/" (expand-file-name "emacs/3rdparty" m/xdg.conf.d)))
