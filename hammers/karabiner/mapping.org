...
**** Command-Tab to Option-Tab for Vmware Horizon
     #+NAME: map_command_tab_to_option_tab_under_vmware_horizon
     #+BEGIN_SRC json :eval never :exports code :noweb yes
       {
         "description": "Change Option-Tab to Command-Tab for Vmware Horizon",
         "manipulators": [
           {
             "type": "basic",
             "from": {
     ...
     #+BEGIN_SRC json :eval never :exports code :noweb yes
       {
         "description": "Change Command-Tab to Option-Tab for Vmware Horizon",
         "manipulators": [
           {
             "type": "basic",
             "from": {
