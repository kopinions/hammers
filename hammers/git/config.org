...
*** git 基本配置
    ...
    #+END_SRC    
    #+BEGIN_SRC gitconfig :tangle (m/resolve "${m/home.d}/.gitconfig") :tangle-mode (identity #o644) :noweb yes
      [user]
	      name = <<username()>>
	      email = <<email()>>
      [alias]
...
*** git commit template
    #+BEGIN_SRC org :tangle "~/.gitcommit.tmpl" :noweb yes :link comment
      type
      # Type(<scope>): <subject>
...
*** git ignore 基本配置
    #+BEGIN_SRC gitignore :tangle (m/resolve "${m/home.d}/.gitignore")
      ### Clangd ###
      # -*- mode: gitignore; -*-
      .clangd
      source/_posts/**/*.png
