...
#+BEGIN_SRC lua :eval never :exports code :tangle (expand-file-name ".hammerspoon/functions.lua" m/home.d) :mkdirp yes :comments link
...
#+BEGIN_SRC lua :eval never :exports code :tangle (expand-file-name ".hammerspoon/init.lua" m/home.d) :mkdirp yes :comments link
...
#+BEGIN_SRC lua :eval never :exports code :tangle (expand-file-name ".hammerspoon/pomodoro.lua" m/home.d) :mkdirp yes :comments link
  local pomodoro = {}
